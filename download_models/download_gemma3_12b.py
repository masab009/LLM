"""
Download google/gemma-3-12b-it from Hugging Face to the Seagate drive.

Usage:
    python download_gemma3_12b.py
...
DOWNLOAD_DIR = "/media/vector/Seagate-2TB/RBT/models/gemma-3-12b-it"
...
def main():
    ...
    print("This will download ~24 GB — may take a while...\n")
