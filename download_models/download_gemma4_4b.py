"""
Download google/gemma-4-E4B from Hugging Face to the Seagate drive.

Usage:
    python download_gemma4_4b.py
...
MODEL_REPO   = "google/gemma-4-E4B"
DOWNLOAD_DIR = "/media/vector/Seagate-2TB/RBT/models/gemma-4-E4B"
...
def main():
    ...
    print("Downloading ~8 GB — this may take a while...\n")
